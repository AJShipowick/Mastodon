        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientSubscription = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ClientsWebsites",
                columns: table => new
                {
                    ClientID = table.Column<string>(nullable: false),
                    AdditionalMessage = table.Column<string>(nullable: true),
                    ClientModelClientID = table.Column<string>(nullable: true),
                    CompanyName = table.Column<string>(nullable: true),
                    MesasgeBody = table.Column<string>(nullable: true),
                    MessageHeader = table.Column<string>(nullable: true),
                    SliderImagePath = table.Column<string>(nullable: true),
                    UniqueWebsiteKey = table.Column<int>(nullable: false),
                    WebsiteName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientsWebsites", x => x.ClientID);
                    table.ForeignKey(
                        name: "FK_ClientsWebsites_ClientModel_ClientModelClientID",
                        column: x => x.ClientModelClientID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientsWebsites_ClientModelClientID",
